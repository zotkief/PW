...
-- Types, procedures and functions
  ...
  begin
    ...
    declare
      Image : constant String := Integer'Image(MaxLabel);
   begin
      Put_Line("MAX_TICKET=" & Image(2..Image'Last));
   end;
...
procedure Lock(I : Integer) is
   ...
   begin
      ...
      for J in Choosing'Range loop
         if Number(J) > Max_Number then
            Max_Number := Number(J);
         end if;
      end loop;
      ...
      for J in Choosing'Range loop
         if J /= I then
               ...
               while (Number(J) /= 0) and then
                     ...
                     ((Number(J) = Number(I)) and then (J < I))) loop
                  null;
               end loop;
         end if;
      end loop;
